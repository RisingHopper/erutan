<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-10 d-flex flex-wrap justify-content-center mt-4">
            ...
            <div class="col-12 col-md-4 mb-5 px-3 g--hover-transform g--transition">
                <div class="card">
                    ...
                    <div class="noticiaDescripcion card-body text-center">
                        ...
                        <p class="card-text g--cut-text-to-1-lines g--cut-text-to-3-lines"> <?= $dataPosts[$x]["description"]; ?> </p>
            ...
            <div class="paginacion text-center d-none d-lg-block col-md-12 mb-3">
                <?php if ($paginaActual > 1): ?>
                    <a href="?pagina=<?php echo $paginaActual - 1; ?>" class="btn g--btn-paginacion"><?=$langTxt["prev"]?></a>
                <?php endif; ?>
                <?php
                ...
                <?php if ($paginaActual < $totalPaginas): ?>
                    <a href="?pagina=<?php echo $paginaActual + 1; ?>" class="btn g--btn-paginacion"><?=$langTxt["next"]?></a>
                <?php endif; ?>
            </div>
                  
            <div class="paginacion text-center d-block d-lg-none mb-4">
                <?php if ($paginaActual > 1): ?>
                    <a href="?pagina=<?php echo $paginaActual - 1; ?>" class="btn g--btn-paginacion"><?=$langTxt["prev"]?></a>
                <?php endif; ?>
                <?php
